class RegularBulking():
    ...
    def calories(self):
      self.min_cal=1.2*self.min_cal
      self.max_cal=1.2*self.max_cal

    def carb(self):
      self.min_carbs=0.25*self.min_cal
      self.max_carbs=0.25*self.max_cal
    ...
    def fat(self):
      self.min_fat=self.min_cal-(self.min_protein+self.min_carbs)
      self.max_fat=self.max_cal-(self.max_protein+self.max_carbs)
